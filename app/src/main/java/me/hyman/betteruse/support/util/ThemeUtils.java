...
public class ThemeUtils {
    ...
    public static int getThemeColor() {
       // return WeiboApplication.getInstance().getResources().getColor(themeColorArr[AppSettings.getThemeColor()][0]);
        return WeiboApplication.getInstance().getResources().getColor(themeColorArr[4][0]);
    }
}
