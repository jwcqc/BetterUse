package me.hyman.betteruse.support.data;
...
public class SharedPreferencesHelper {
    ...
    private static final String FILE_NAME = "weibo_data";
   ...
   /* public static synchronized void init(Context context) {
    ...
    public static SharedPreferencesHelper getInstance() {
        if (instance == null) {
            instance = new SharedPreferencesHelper(WeiboApplication.getInstance());
        }
        return instance;
    }
