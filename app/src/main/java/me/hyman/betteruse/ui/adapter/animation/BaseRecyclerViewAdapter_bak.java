...
package me.hyman.betteruse.ui.adapter.animation;
...
import me.hyman.betteruse.ui.adapter.BaseViewHolder;
...
public abstract class BaseRecyclerViewAdapter_bak<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
/**
    ...
    protected static final String TAG = BaseRecyclerViewAdapter_bak.class.getSimpleName();
    protected Context mContext;
    protected int mLayoutResId;
    protected LayoutInflater mLayoutInflater;
    protected List<T> mData;
    protected static final int TYPE_HEADER_VIEW = 0x00000111;
    protected static final int TYPE_LOADING_VIEW = 0x00000222;
    protected static final int TYPE_FOOTER_VIEW = 0x00000333;
    protected static final int TYPE_EMPTY_VIEW = 0x00000555;
...
/**
    ...
    public interface OnRecyclerViewItemChildClickListener {
        void onItemChildClick(BaseRecyclerViewAdapter_bak adapter, View view, int position);
    }
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(BaseRecyclerViewAdapter_bak.this, v, position - getHeaderViewCount());
        }
    }
...
/**
    ...
    public BaseRecyclerViewAdapter_bak(Context context, int layoutResId, List<T> data) {
    ...
    public BaseRecyclerViewAdapter_bak(Context context, List<T> data) {
        this(context, 0, data);
    }

    public BaseRecyclerViewAdapter_bak(Context context, View contentView, List<T> data) {
        this(context, 0, data);
        mContentView = contentView;
    }

    public BaseRecyclerViewAdapter_bak(Context context) {
        this(context, null);
    }
...
/**
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (type == TYPE_EMPTY_VIEW || type == TYPE_HEADER_VIEW || type == TYPE_FOOTER_VIEW || type == TYPE_LOADING_VIEW) {
            setFullSpan(holder);
        }
    }
